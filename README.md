...
<Variable name="keycolor" description="Main Color" type="color" default="$(main.color)" value="#eb3349"/>
...
<Group description="Theme Colors" selector="body">
 <Variable name="main.color" description="Theme Color" type="color" default="#eb3349" value="#eb3349"/>
  <Variable name="main.dark.color" description="Dark Color" type="color" default="#111111" value="#111111"/>
  <Variable name="header.bg1" description="Header BG1" type="color" default="#eb3349" value="#eb3349"/>
  <Variable name="header.bg2" description="Header BG2" type="color" default="#f45c43" value="#f45c43"/>
  <Variable name="menu.color" description="Menu Color" type="color" default="#171717" value="#171717"/>
...
<Group description="Theme Body" selector="body">
  ...
  <Variable name="body.link.color" description="Link Color" type="color" default="$(main.color)"  value="#eb3349"/>
</Group>
...
<Variable name="posts.title.color" description="Post title color" hideEditor="true" type="color" default="#171717"  value="#171717"/>
<Variable name="posts.text.color" description="Post text color" hideEditor="true" type="color" default="#656565"  value="#656565"/>
<Variable name="posts.icons.color" description="Post icons color" hideEditor="true" type="color" default="$(main.color)"  value="#eb3349"/>
<Variable name="labels.background.color" description="Label background color" hideEditor="true" type="color" default="$(main.color)"  value="#eb3349"/>
*/
...
/*-- Body Content CSS --*/
body{background:$(body.background);background-color:$(body.background.color);font-family:'Poppins',sans-serif;font-size:14px;font-weight:400;color:$(body.text.color);word-wrap:break-word;margin:0;padding:0}
...
.header-header{background:linear-gradient(to right,$(header.bg1) 40%,$(header.bg2));width:100%;height:40px;position:relative;overflow:hidden;padding:15px 0}
...
.header-logo h1 a:hover{color:$(main.color)}
.header-logo p{font-size:12px;margin:5px 0 0}
#header-social{float:right}
.header-social li{float:left;margin:5px 0 0 10px}
.header-social li a{display:block;width:30px;background-color:#fff;font-size:18px;color:$(header.bg2);text-align:center;line-height:30px;padding:0;border-radius:30px;transition:color .17s ease}
.header-social li a:hover{color:$(title.color)}
...
#main-menu ul > li > a{position:relative;color:$(menu.color);font-size:13px;font-weight:600;text-transform:uppercase;line-height:48px;display:inline-block;margin:0;padding:0 13px;transition:color .17s ease}
#main-menu ul#main-menu-nav > li:first-child > a{padding:0 13px 0 0}
#main-menu ul > li:hover > a{color:$(main.color)}
#main-menu ul > li > ul{position:absolute;float:left;left:0;top:48px;width:180px;background-color:$(main.dark.color);z-index:99999;margin:0;padding:0;box-shadow:0 3px 5px rgba(0,0,0,0.2);visibility:hidden;opacity:0}
...
.show-search{position:absolute;right:0;top:10px;display:block;height:28px;line-height:24px;z-index:20;color:$(menu.color);font-size:13px;text-align:right;cursor:pointer;box-sizing:border-box;padding:0 10px;border:2px solid $(menu.color);border-radius:28px;transition:all .17s ease}
.show-search:hover{color:$(main.color)}
.search-active .show-search{border-color:$(main.color)}
#nav-search{position:absolute;right:0;top:48px;width:250px;height:48px;z-index:10;background-color:$(main.dark.color);box-sizing:border-box;padding:10px;visibility:hidden;opacity:0;transition:all .25s ease}
.search-active #nav-search{visibility:visible;opacity:1}
#nav-search .search-form{width:100%;height:28px;background-color:rgba(0,0,0,0);line-height:28px;overflow:hidden;padding:0;border:0}
#nav-search .search-input{width:100%;height:28px;font-family:inherit;color:#fff;margin:0;padding:0 10px;background-color:rgba(255,255,255,0.05);font-size:13px;font-weight:400;box-sizing:border-box;border:0;border-radius:3px}
#nav-search .search-input:focus{color:#fff;outline:none}
.slide-menu-toggle{display:none;position:absolute;line-height:48px;height:48px;width:48px;top:0;left:0;font-family:FontAwesome;color:$(menu.color);font-size:17px;font-weight:400;text-align:left;cursor:pointer;z-index:4;padding:0}
...
.queryMessage a.show-more{float:right;color:$(main.color);text-decoration:underline;transition:opacity .17s}
.queryMessage a.show-more:hover{opacity:.8}
.queryEmpty{font-size:13px;font-weight:400;padding:10px 0;margin:0 0 25px;text-align:center}
.title-wrap{position:relative;float:left;width:100%;margin:0 0 20px}
.title-wrap > h3{position:relative;display:block;font-size:13px;color:$(title.color);font-weight:600;text-transform:uppercase;line-height:13px;padding:0 0 13px;margin:0;border-bottom:2px solid #ebebeb}
.title-wrap > h3:before{content:'';position:absolute;height:2px;width:30px;left:0;bottom:0;background-color:$(main.color);margin:0 0 -2px}
...
.index-post:hover .post-info > h2 > a{color:$(main.color)}
...
.item-post h1.post-title{color:$(title.color);font-size:25px;line-height:1.6em;font-weight:700;position:relative;display:block;margin:0 0 15px;padding:0}
...
.post-labels span,.post-labels a{float:left;height:22px;background-color:#fff;color:$(title.color);font-size:12px;line-height:22px;font-weight:400;margin:0;padding:0 10px;border:1px solid #ebebeb}
.post-labels span{background-color:$(main.color);color:#fff;border-color:$(main.color)}
.post-labels a{margin:0 0 0 5px;transition:all .17s ease}
.post-labels a:hover{background-color:$(main.color);color:#fff;border-color:$(main.color)}
.post-reactions{height:28px;display:block;margin:0 0 15px}
.post-reactions span{float:left;color:$(title.color);font-size:12px;line-height:25px;text-transform:uppercase;font-weight:600}
...
.post-nav li:hover a{color:$(main.color)}
...
.blog-pager a,.blog-pager span{float:left;display:block;min-width:30px;height:30px;background-color:#fff;color:$(title.color);font-size:12px;font-weight:600;line-height:28px;text-align:center;box-sizing:border-box;padding:0 10px;margin:0 5px 0 0;border:1px solid #ebebeb;transition:all .17s ease}
.blog-pager span.page-dots{min-width:20px;background-color:#fff;font-size:16px;color:$(body.text.color);font-weight:400;line-height:30px;padding:0;border:0}
...
.comments .comment .comment-actions a{margin-right:5px;padding:2px 5px;background-color:#f2f2f2;color:$(title.color);font-weight:400;font-size:10px;border-radius:2px;transition:all .17s ease}
...
.emoji-toggle{display:inline-block;background-color:$(main.color);color:#fff;height:26px;line-height:26px;font-size:14px;cursor:pointer;padding:0 10px;margin:0 0 10px;border-radius:2px;transition:background .17s ease}
.emoji-toggle:hover{background-color:$(main.dark.color)}
...
.sidebar .widget-title > h3{position:relative;display:block;font-size:13px;color:$(title.color);font-weight:600;text-transform:uppercase;line-height:13px;padding:0 0 13px;margin:0;border-bottom:2px solid #ebebeb}
.sidebar .widget-title > h3:before{content:'';position:absolute;height:2px;width:30px;left:0;bottom:0;background-color:$(main.color);margin:0 0 -2px}
...
.list-label li a:before{content:"\f054";float:left;color:$(title.color);font-weight:400;font-family:FontAwesome;font-size:6px;margin:7px 3px 0 0;transition:color .17s}
.list-label li a:hover{color:$(main.color)}
.list-label .label-count{position:relative;float:right;font-size:11px;font-weight:400;text-align:center;line-height:16px}
.cloud-label li{position:relative;float:left;margin:0 5px 5px 0}
.cloud-label li a{display:block;height:26px;color:$(title.color);font-size:12px;line-height:26px;font-weight:400;padding:0 10px;border:1px dotted #ebebeb;transition:all .17s ease}
...
.FollowByEmail .widget-content > h3{font-size:17px;color:$(title.color);font-weight:700;margin:0 0 13px}
...
.FollowByEmail .follow-by-email-inner .follow-by-email-submit{width:100%;height:32px;font-family:inherit;font-size:11px;color:#fff;background-color:$(main.color);text-transform:uppercase;text-align:center;font-weight:600;cursor:pointer;margin:0;border:0;transition:background .17s ease}
...
.FeaturedPost .post:hover .post-title a{color:$(main.color)}
...
#footer-wrapper{display:block;width:100%;overflow:hidden;background-color:$(main.dark.color);color:#fff;padding:0}
#footer-wrapper .container{overflow:hidden;margin:0 auto;padding:15px 0}
#footer-wrapper .copyright-area{float:left;font-size:12px;display:block;height:34px;line-height:34px}
#footer-wrapper .copyright-area a{color:$(main.color);transition:color .17s}
...
body#layout{width:860px;position:relative;padding:95px 5px 0;margin:0}
...
body#layout div.header-logo,body#layout div.header-social{float:left;width:50%;height:auto;max-width:none;max-height:none}
...
body#layout .slider-section{float:none;width:auto}
...
body#layout .home-ad .widget-content{float:none;width:auto;margin:0}
/*------Layout (end)----------*/
]]></b:template-skin>
</b:if>
          ...
          <b:loop values='data:links' var='link'>
            <b:if cond='data:link.name == &quot;boxedVersion&quot;'>
              <b:if cond='data:link.target == &quot;true&quot;'>
                #outer-wrapper{max-width:1030px}.main-slider,.main-slider li{height:250px}
              </b:if>
            </b:if>
          </b:loop>
          &lt;/style&gt;
...
<div id='outer-wrapper'>
  ...
  <div id='header-wrap'>
    ...
    <div class='header-header'>    
      <div class='container row'>
        <b:section class='header-logo' id='header-logo' maxwidgets='1' name='Header Logo' showaddelement='yes'>
          <b:widget id='Header1' locked='true' title='Animo (Header)' type='Header' version='2' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='displayUrl'>http://4.bp.blogspot.com/-BH0MyzdjxVs/W-yIUqnjgPI/AAAAAAAADjo/LjeqJrlfONApVmvDsSZbiDZmGQMmFYZwQCK4BGAYYCw/s1600/logo.png</b:widget-setting>
              <b:widget-setting name='displayHeight'>40</b:widget-setting>
              <b:widget-setting name='sectionWidth'>414</b:widget-setting>
              <b:widget-setting name='useImage'>true</b:widget-setting>
              <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
              <b:widget-setting name='imagePlacement'>REPLACE</b:widget-setting>
              <b:widget-setting name='displayWidth'>141</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main' var='this'>
              <div class='header-widget'>
                <b:include cond='data:imagePlacement in {&quot;REPLACE&quot;, &quot;BEFORE_DESCRIPTION&quot;}' name='image'/>
        ...
        <b:section class='header-social social' id='header-social' maxwidgets='1' name='Header Social' showaddelement='yes'>
    ...
    <div class='header-menu'>
      ...
      <div class='container row'>
        ...
        <b:section class='main-menu' id='main-menu' maxwidgets='1' name='Main Menu' showaddelement='yes'>
          <b:widget id='LinkList74' locked='true' title='Link List' type='LinkList' version='2' visible='true'>
            <b:widget-settings>
              ...
              <b:widget-setting name='link-1'>#</b:widget-setting>
              <b:widget-setting name='link-2'>#</b:widget-setting>
              <b:widget-setting name='link-12'>https://www.soratemplates.com/2019/06/animo-blogger-templates.html</b:widget-setting>
              <b:widget-setting name='link-0'>/</b:widget-setting>
              <b:widget-setting name='link-11'>https://youtu.be/J_lTmoOtnT0</b:widget-setting>
              <b:widget-setting name='link-10'>https://www.sorabloggingtips.com/2019/06/how-to-setup-animo-blogger-template.html</b:widget-setting>
              <b:widget-setting name='text-9'>Mega Menu</b:widget-setting>
              <b:widget-setting name='link-9'>recent/mega-menu</b:widget-setting>
              ...
              <b:widget-setting name='link-8'>https://animo-soratemplates.blogspot.com/soratemplates</b:widget-setting>
              <b:widget-setting name='link-5'>#</b:widget-setting>
              <b:widget-setting name='link-6'>https://animo-soratemplates.blogspot.com/p/post-format-and-page-markup_4.html</b:widget-setting>
              <b:widget-setting name='link-3'>#</b:widget-setting>
        ...
        <span class='show-search'><data:messages.search/></span>
      </div>
    </div>
  ...
  <b:if cond='data:view.isHomepage'> 
    <!-- Main Slider -->
      <b:section class='slider-section' id='slider-section' maxwidgets='1' name='Main Slider' showaddelement='yes'>
        <b:widget id='HTML2' locked='false' title='' type='HTML' version='2' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='content'>6/recent/slider</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
            <b:include name='widget-title'/>
            <div class='widget-content'>
      ...
      <div id='main-wrapper'>
        <b:if cond='data:view.isHomepage'>
          <b:section class='home-ad' id='home-ad' maxwidgets='1' name='Home Ads' showaddelement='yes'>
            <b:widget id='HTML1' locked='false' title='Header ADS' type='HTML' visible='true'>
              <b:widget-settings>
                <b:widget-setting name='content'><![CDATA[<img alt='Home Ads' src='https://3.bp.blogspot.com/-NEGfItydtbs/W-wqQXuT_yI/AAAAAAAADjc/IrKSFBD51AgZuX7UPtQIseAEgT-DOLsWwCK4BGAYYCw/s1600/ads.jpg'/>]]></b:widget-setting>
              </b:widget-settings>
              <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
        ...
        <b:section class='main' id='main' maxwidgets='1' name='Main Posts' showaddelement='yes'>
          <b:widget id='Blog1' locked='true' title='Blog Posts' type='Blog' version='2' visible='true'>
            <b:widget-settings>
              ...
              <b:widget-setting name='style.urlcolor'>#f45c43</b:widget-setting>
              <b:widget-setting name='showAuthor'>true</b:widget-setting>
              <b:widget-setting name='style.linkcolor'>#eb3349</b:widget-setting>
            ...
            <b:includable id='commentFormIframeSrc' var='post'>
              <span class='emoji-toggle'><i class='fa fa-smile-o'/> Emoji</span>
              <div id='emoji-box'>
                <div class='mj-item'><span class='sora-moji mj-0'/>(y)</div>
                <div class='mj-item'><span class='sora-moji mj-1'/>:)</div>
                <div class='mj-item'><span class='sora-moji mj-2'/>:(</div>
                <div class='mj-item'><span class='sora-moji mj-3'/>hihi</div>
                <div class='mj-item'><span class='sora-moji mj-4'/>:-)</div>
                <div class='mj-item'><span class='sora-moji mj-5'/>:D</div>
                <div class='mj-item'><span class='sora-moji mj-6'/>=D</div>
                <div class='mj-item'><span class='sora-moji mj-7'/>:-d</div>
                <div class='mj-item'><span class='sora-moji mj-8'/>;(</div>
                <div class='mj-item'><span class='sora-moji mj-9'/>;-(</div>
                <div class='mj-item'><span class='sora-moji mj-10'/>@-)</div>
                <div class='mj-item'><span class='sora-moji mj-11'/>:P</div>
                <div class='mj-item'><span class='sora-moji mj-12'/>:o</div>
                <div class='mj-item'><span class='sora-moji mj-13'/>:&gt;)</div>
                <div class='mj-item'><span class='sora-moji mj-14'/>(o)</div>
                <div class='mj-item'><span class='sora-moji mj-15'/>:p</div>
                <div class='mj-item'><span class='sora-moji mj-16'/>(p)</div>
                <div class='mj-item'><span class='sora-moji mj-17'/>:-s</div>
                <div class='mj-item'><span class='sora-moji mj-18'/>(m)</div>
                <div class='mj-item'><span class='sora-moji mj-19'/>8-)</div>
                <div class='mj-item'><span class='sora-moji mj-20'/>:-t</div>
                <div class='mj-item'><span class='sora-moji mj-21'/>:-b</div>
                <div class='mj-item'><span class='sora-moji mj-22'/>b-(</div>
                <div class='mj-item'><span class='sora-moji mj-23'/>:-#</div>
                <div class='mj-item'><span class='sora-moji mj-24'/>=p~</div>
                <div class='mj-item'><span class='sora-moji mj-25'/>x-)</div>
                <div class='mj-item'><span class='sora-moji mj-26'/>(k)</div>
              </div>
            ...
            <b:includable id='headerByline' var='post'>
              <!-- Post Header Meta -->
                <div class='post-meta'>
                  <b:include cond='data:view.isPost' data='post' name='postAuthor'/>
  ...
  <div class='blog-pager container' id='blog-pager'>
    ...
    <b:include cond='data:view.url != data:blog.homepageUrl' name='homePageLink'/>
      ...
      <div id='sidebar-wrapper'>
        <b:section class='sidebar common-widget' id='sidebar1' name='Sidebar Right' showaddelement='yes'>
        ...
        <div class='post-content'>
          ...
          <b:widget id='FeaturedPost1' locked='false' title='Featured Post' type='FeaturedPost' visible='true'>
            <b:widget-settings>
              ...
              <b:widget-setting name='postId'>421252502949487544</b:widget-setting>
    ...
    <span class='label-size'>
      ...
      <ul>
        <b:loop values='data:labels' var='label'>
          ...
          <b:widget id='Label4' locked='false' title='Tags' type='Label' version='2' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='sorting'>ALPHA</b:widget-setting>
    ...
    <b:section class='menu-footer' id='menu-footer' maxwidgets='1' name='Footer Menu' showaddelement='yes'>
      <b:widget id='LinkList76' locked='true' title='Footer Menu Widget' type='LinkList' version='2' visible='true'>
        <b:widget-settings>
          ...
          <b:widget-setting name='link-1'>https://animo-soratemplates.blogspot.com/p/about_4.html</b:widget-setting>
          <b:widget-setting name='text-0'>Home</b:widget-setting>
          <b:widget-setting name='link-2'>https://animo-soratemplates.blogspot.com/p/contact-us_4.html</b:widget-setting>
          <b:widget-setting name='link-0'>/</b:widget-setting>
